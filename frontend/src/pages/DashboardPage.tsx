...
import { getRules } from '../api/automation';
import MetricCards from '../components/dashboard/MetricCards';
import TrendChart from '../components/charts/TrendChart';
import DevicePanel from '../components/dashboard/DevicePanel';
import AlertList from '../components/dashboard/AlertList';
import RulePanel from '../components/dashboard/RulePanel';
    ...
    <Space direction="vertical" size={20} style={{ width: '100%' }}>
      <div className="page-heading">
        <div>
          ...
          <Text type="secondary">每 30 秒自动刷新 · WebSocket 实时报警与联动推送</Text>
        </div>
        <Space>
          <Select
            aria-label="选择温室"
          ...
          />
          <Button type="primary" icon={<ThunderboltOutlined />} onClick={runSimulation}>
            生成模拟数据
          </Button>
        </Space>
      </div>
